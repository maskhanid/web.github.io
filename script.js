...
(function() {
  ...
  function initParticles() {
    if (typeof particlesJS !== 'undefined') {
      particlesJS('particles-js', {
        particles: {
          number: { value: window.innerWidth < 768 ? 30 : 80, density: { enable: true, value_area: 900 } },
  ...
  // ===== SELL CARD GSAP ANIMATION =====
if (typeof gsap !== 'undefined') {
  gsap.fromTo('.sell-card',
    {
      opacity: 0,
      y: 80,
      scale: 0.9
  ...
  function initCardTilt() {
    const cards = document.querySelectorAll('.link-card, .feature-card, .sell-card');
    cards.forEach(card => {
